...
class biGRUCell(object):
  ...
  def __init__(self, input_size, hidden_layer_size, target_size):
    ...
    self.Wo = tf.Variable(tf.random.truncated_normal([self.hidden_layer_size * 2, self.target_size], mean=0, stddev=0.01))
    self.bo = tf.Variable(tf.random.truncated_normal([self.target_size], mean=0, stddev=0.01))
